        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '膳食标题' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.meishiName" placeholder="膳食标题"
                            clearable></el-input>
                    </el-form-item>

                    <el-form-item :label="contents.inputTitle == 1 ? '膳食类型' : ''">
                        <el-select v-model="searchForm.meishiTypes" placeholder="请选择膳食类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option v-for="(item, index) in meishiTypesSelectSearch" v-bind:key="index"
                ...
                <el-row class="ad"
                    ...
                    <el-form-item>
                        <el-button v-if="isAuth('meishiCollection', '新增')" type="success" icon="el-icon-plus"
                            @click="addOrUpdateHandler()">新增</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('meishiCollection', '删除')" :disabled="dataListSelections.length <= 0"
                            type="danger" icon="el-icon-delete" @click="deleteHandler()">删除</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('meishiCollection', '报表')" type="success" icon="el-icon-pie-chart"
                            @click="chartDialog()">报表</el-button>
                        &nbsp;
                        <a style="text-decoration:none" class="el-button el-button--success"
                            v-if="isAuth('meishiCollection', '导入导出')" icon="el-icon-download"
                            href="http://localhost:8080/gerenjiankangguanlixitong/upload/meishiCollectionMuBan.xls">批量导入膳食信息收藏数据模板</a>
                        &nbsp;
                        <el-upload v-if="isAuth('meishiCollection', '导入导出')" style="display: inline-block"
                            :action="getActionUrl" :on-success="meishiCollectionUploadSuccess"
                            :on-error="meishiCollectionUploadError" :show-file-list=false>
                            <el-button v-if="isAuth('meishiCollection', '导入导出')" type="success"
                                icon="el-icon-upload2">批量导入膳食信息收藏数据</el-button>
                        </el-upload>
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('meishiCollection', '导入导出')" style="display: inline-block"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    v-if="isAuth('meishiCollection', '查看')" :data="dataList" v-loading="dataListLoading"
                    @selection-change="selectionChangeHandler">
                    <el-table-column v-if="contents.tableSelection" type="selection" header-align="center"
                        align="center" width="50">
                    </el-table-column>
                    <el-table-column label="索引" v-if="contents.tableIndex" type="index" width="50" />
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="meishiName"
                        header-align="center" label="膳食标题">
                        <template slot-scope="scope">
                            {{ scope.row.meishiName }}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="meishiPhoto"
                        header-align="center" width="200" label="膳食照片">
                        <template slot-scope="scope">
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="meishiTypes"
                        header-align="center" label="膳食类型">
                        <template slot-scope="scope">
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="insertTime"
                        header-align="center" label="收藏时间">
                        <template slot-scope="scope">
                    ...
                    <el-table-column width="300" :align="contents.tableAlign" header-align="center" label="操作">
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="sessionTable == 'false'" type="success" icon="el-icon-printer" size="mini"
                                @click="dayinOpen(scope.row)">打印</el-button>
                            <el-button v-if="isAuth('meishiCollection', '查看')" type="success" icon="el-icon-tickets"
                                size="mini" @click="addOrUpdateHandler(scope.row.id, 'info')">详情</el-button>
                            <el-button v-if="isAuth('meishiCollection', '修改')" type="primary" icon="el-icon-edit"
                                size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
                            <el-button v-if="isAuth('meishiCollection', '删除')" type="danger" icon="el-icon-delete"
