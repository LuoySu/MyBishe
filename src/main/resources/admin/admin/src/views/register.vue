    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">运动爱好和健康管理平台注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="用户出生年月" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuIdNumber" autocomplete="off" placeholder="用户出生年月"  />
                        </el-form-item>
                        <!--
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/sportshealth/img/back-img-bg.jpeg);
