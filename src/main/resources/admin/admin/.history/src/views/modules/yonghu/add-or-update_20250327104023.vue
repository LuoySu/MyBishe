            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type != 'info'" label="用户出生年月" prop="yonghuIdNumber">
                        <el-date-picker v-model="ruleForm.yonghuIdNumber" type="date" format="yyyy 年 MM 月 dd 日"
                    ...
                    <div v-else-if="type == 'info'">
                        <el-form-item class="input" label="用户出生年月" prop="yonghuIdNumber">
                            <el-input v-model="ruleForm.yonghuIdNumber" placeholder="用户出生年月" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
