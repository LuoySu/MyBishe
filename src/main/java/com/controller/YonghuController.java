...
//            .eq("yonghu_id_number", yonghu.getYonghuIdNumber())
        ...
        if(yonghuEntity==null){
            ...
            return R.error(511,"账户或者用户手机号已经被使用");
        }
    }
...
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //用户出生年月 要改的
...
//                            }
//                            return R.error(511,"数据库的该表中的 [用户出生年月] 字段已经存在 存在数据为:"+repeatFields.toString());
//                        }
