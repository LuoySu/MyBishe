...
public class YundongCollectionEntity<T> implements Serializable {
     ...
     * 运动教程
     */
    @ColumnInfo(comment="运动教程",type="int(11)")
    @TableField(value = "yundong_id")
    ...
    @TableField(value = "yundong_collection_types")
