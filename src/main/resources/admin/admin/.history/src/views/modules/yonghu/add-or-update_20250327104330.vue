            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type != 'info'" label="用户姓名" prop="yonghuName">
                        <el-input v-model="ruleForm.yonghuName" placeholder="用户姓名" clearable
                            :readonly="ro.yonghuName"></el-input>
                    </el-form-item>
                    <div v-else-if="type == 'info'">
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type != 'info'" label="用户手机号" prop="yonghuPhone">
                        <el-input v-model="ruleForm.yonghuPhone" placeholder="用户手机号" clearable
                            :readonly="ro.yonghuPhone"></el-input>
                    </el-form-item>
                    <div v-else-if="type == 'info'">
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type != 'info'" label="用户出生年月" prop="yonghuIdNumber">
                        <el-date-picker v-model="ruleForm.yonghuIdNumber" type="date"
                            value-format="yyyy-MM-dd" placeholder="选择用户出生年月" clearable :readonly="ro.yonghuIdNumber">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type == 'info'">
                        <el-form-item class="input" label="用户出生年月" prop="yonghuIdNumber">
                            <el-date-picker v-model="ruleForm.yonghuIdNumber" type="date" format="yyyy年MM月dd日"
                            value-format="yyyy-MM-dd" placeholder="选择用户出生年月" readonly>
                        </el-date-picker>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    data() {
        return {
            ...
            rules: {
                ...
                // yonghuIdNumber: [
                //     { required: true, message: '用户出生年月不能为空', trigger: 'blur' },
                //     {
