...
public class SuppliesCollectionView extends SuppliesCollectionEntity implements Serializable {
	...
	*/
	...
	private String suppliesCollectionValue;
	...
	public SuppliesCollectionView() {

	}

	public SuppliesCollectionView(SuppliesCollectionEntity suppliesCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, suppliesCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getSuppliesCollectionValue() {
		return suppliesCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setSuppliesCollectionValue(String suppliesCollectionValue) {
		this.suppliesCollectionValue = suppliesCollectionValue;
	}
	...
	public String toString() {
		return "SuppliesCollectionView{" +
			", suppliesCollectionValue=" + suppliesCollectionValue +
